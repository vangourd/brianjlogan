...
BLOG_AUTHOR = "Brian Logan"  # (translatable)
BLOG_TITLE = "Brian J Logan's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://brianjlogan.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://brianjosephlogan.com/"
BLOG_EMAIL = "id@brianjlogan.com"
BLOG_DESCRIPTION = "Thoughts and musings of a Floridian technologist"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("https://family.brianjlogan.com","Family 👪"),
        ("https://brianjlogan.com/pages/about/","About"),
        ("https://docs.google.com/forms/d/e/1FAIpQLSdB3IfeDbLuTPJk6YsyNZBubMvMOwgtA4fl6qKQJCUyssjD8Q/viewform?usp=sf_link","Contact"),
